<?php
/**
 * @version $Header: /cvsroot/bitweaver/_bit_gmap/edit_markerset.php,v 1.19 2008/06/25 22:21:10 spiderr Exp $
 *
...
//Check if this to remove from a map, or to delete completely
	...
	$gBitSystem->display('bitpackage:gmap/edit_markerset.tpl', NULL, 'center_only', array( 'display_mode' => 'edit' ));
	die;
}
