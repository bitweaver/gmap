...
{form action="javascript:;" enctype="multipart/form-data" id="edit-maptype-options-form"}
	...
	<div class="row">
		{formlabel label="Min Zoom" for="minzoom"}
			{forminput}
				<input name="minzoom" type="text" size="3" value="{if $maptypeInfo.minzoom}{$maptypeInfo.minzoom}{else}0{/if}"><br/>
				{formhelp note=""}
			{/forminput}
	</div>
	<div class="row">
		{formlabel label="Max Zoom" for="maxzoom"}
			{forminput}
				<input name="maxzoom" type="text" size="3" value="{if $maptypeInfo.maxzoom}{$maptypeInfo.maxzoom}{else}16{/if}"><br/>
				{formhelp note=""}
			{/forminput}
	</div>
	<div class="row">
