		...
		{else}
			{if $listInfo.current_page > 1}
				{if $gBitThemes->isAjaxRequest()}
					&nbsp;<a href="javascript:void(0);" onclick="{$ajaxHandler}( {$ajaxParams}, '{$pageUrlVar}&amp;list_page={$listInfo.current_page-1}' );">&laquo;</a>
				{else}
					&nbsp;<a href="{$pageUrl}&amp;list_page={$listInfo.current_page-1}">&laquo;</a>&nbsp;
				{/if}
			{/if}
			...
			{if $listInfo.current_page < $listInfo.total_pages}
				{if $gBitThemes->isAjaxRequest()}
					&nbsp;<a href="javascript:void(0);" onclick="{$ajaxHandler}( {$ajaxParams}, '{$pageUrlVar}&amp;list_page={$listInfo.current_page+1}' );">&raquo;</a>
				{else}
					&nbsp;<a href="{$pageUrl}&amp;list_page={$listInfo.current_page+1}">&raquo;</a>&nbsp;
				{/if}
			{/if}
