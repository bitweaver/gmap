	...
	*}
	...
	<div class="row">
		{formlabel label="Shadow Width" for="shadow_w"}
			{forminput}
				<input name="shadow_w" type="text" size="5" value="{if $shadowstyleInfo.shadow_w}{$shadowstyleInfo.shadow_w}{else}37{/if}"></div>
				{formhelp note=""}
			{/forminput}
	</div>
	<div class="row">
		{formlabel label="Shadow Height" for="shadow_h"}
			{forminput}
				<input name="shadow_h" type="text" size="5" value="{if $shadowstyleInfo.shadow_h}{$shadowstyleInfo.shadow_h}{else}34{/if}"></div>
				{formhelp note=""}
			{/forminput}
	</div>
	<div class="row">
		{formlabel label="Shadow Anchor X" for="shadow_anchor_x"}
			{forminput}
				<input name="shadow_anchor_x" type="text" size="5" value="{if $shadowstyleInfo.shadow_anchor_x}{$shadowstyleInfo.shadow_anchor_x}{else}18{/if}"></div>
				{formhelp note=""}
			{/forminput}
	</div>
	<div class="row">
		{formlabel label="Shadow Anchor Y" for="shadow_anchor_y"}
			{forminput}
				<input name="shadow_anchor_y" type="text" size="5" value="{if $shadowstyleInfo.shadow_anchor_y}{$shadowstyleInfo.shadow_anchor_y}{else}25{/if}"></div>
				{formhelp note=""}
			{/forminput}
	</div>
