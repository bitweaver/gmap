...
BitMap.Edit.editMapTypes = function(){
...
BitMap.Edit.newMarker = function(){
		var check = false;
...
BitMap.Edit.editMarkers = function(){		
...
BitMap.Edit.newIconStyle = function(){
		var check = false;
  	for (var i=0; i<bMSetData.length; i++){
  		if ( bMSetData[i] != null ){
				check = true;
...
BitMap.Edit.editIconStyles = function(){
...
BitMap.Edit.newMarkerStyle = function(){
		var check = false;
  	for (var i=0; i<bMSetData.length; i++){
  		if ( bMSetData[i] != null ){
				check = true;
...
BitMap.Edit.editMarkerStyles = function(){
...
BitMap.Edit.newPolyline = function(){
		var check = false;
...
BitMap.Edit.editPolylines = function(){
...
BitMap.Edit.editPolylineStyles = function(){
...
BitMap.Edit.newPolylineStyle = function(){
		var check = false;
  	for (var i=0; i<bLSetData.length; i++){
  		if ( bLSetData[i] != null ){
				check = true;
...
BitMap.Edit.newPolygon = function(){
		var check = false;
  	for (var i=0; i<bPSetData.length; i++){
  		if ( bPSetData[i] != null ){
				check = true;
...
/* @todo needs to support markers in bSLData as well as bLData */
BitMap.Edit.editPolygons = function(){
...
BitMap.Edit.editPolygonStyles = function(){
...
BitMap.Edit.newPolygonStyle = function(){
		var check = false;
  	for (var i=0; i<bPSetData.length; i++){
  		if ( bPSetData[i] != null ){
				check = true;
...
BitMap.Edit.updateRemoveMarkerSet = function(){
  	for (var n=0; n<bMData.length; n++){
...
BitMap.Edit.updateRemovePolyline = function(){
...
//this needs special attention
BitMap.Edit.updateRemovePolylineSet = function(){
...
BitMap.Edit.updateRemovePolygon = function(){
...
BitMap.Edit.updateRemovePolygonSet = function(){
	for (var n=0; n<bPData.length; n++){
