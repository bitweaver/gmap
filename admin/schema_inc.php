...
/***************************************
 *
 * Above here is the service stuff which is functional, below is a rough R2 makeover of R1
 *
 * @todo what needs to be done is the stuff below needs to be remade using 
 * the geo package and incorporated with the service stuff above.
 *
 ***************************************/
...
$gBitInstaller->registerUserPermissions( GMAP_PKG_NAME, array(
	...
	array('bit_gm_edit_polygon', 'Can edit polygons', 'registered', GMAP_PKG_NAME),
	array('bit_gm_view_polygon', 'Can view polygons', 'basic', GMAP_PKG_NAME),
	array('bit_gm_remove_polygon', 'Can remove polygons', 'editors', GMAP_PKG_NAME),
	array('bit_gm_rollback_polygon', 'Can rollback polygons', 'editors', GMAP_PKG_NAME),
	array('bit_gm_admin_polygon', 'Can admin the polygons', 'editors', GMAP_PKG_NAME),
	array('bit_gm_rename_polygon', 'Can rename polygons', 'editors', GMAP_PKG_NAME),
	array('bit_gm_lock_polygon', 'Can lock polygons', 'editors', GMAP_PKG_NAME),

	array('bit_gm_edit_polygon_sets', 'Can edit polygon sets', 'registered', GMAP_PKG_NAME),
	array('bit_gm_view_polygon_sets', 'Can view polygon sets', 'basic', GMAP_PKG_NAME),
	array('bit_gm_remove_polygon_sets', 'Can remove polygon sets', 'editors', GMAP_PKG_NAME),
	array('bit_gm_rollback_polygon_sets', 'Can rollback polygon sets', 'editors', GMAP_PKG_NAME),
	array('bit_gm_admin_polygon_sets', 'Can admin the polygon sets', 'editors', GMAP_PKG_NAME),
	array('bit_gm_rename_polygon_sets', 'Can rename polygon sets', 'editors', GMAP_PKG_NAME),
	array('bit_gm_lock_polygon_sets', 'Can lock ploygon sets', 'editors', GMAP_PKG_NAME),
...
// ### Default Preferences
$gBitInstaller->registerPreferences( GMAP_PKG_NAME, array(
	array(GMAP_PKG_NAME, 'gmap_anonCanEdit','n'),
	array(GMAP_PKG_NAME, 'gmap_autolinks','y'),
	array(GMAP_PKG_NAME, 'gmap_backlinks','y'),
	array(GMAP_PKG_NAME, 'gmap_dump','y'),
	array(GMAP_PKG_NAME, 'gmap_history','y'),
	array(GMAP_PKG_NAME, 'gmap_lastChanges','y'),
	array(GMAP_PKG_NAME, 'gmap_listPages','y'),
	array(GMAP_PKG_NAME, 'gmap_page_title','y'),
	array(GMAP_PKG_NAME, 'gmap_warn_on_edit','n'),
	array(GMAP_PKG_NAME, 'gmap_gmap','y'),
	array(GMAP_PKG_NAME, 'gmap_gmap_comments','n'),
	array(GMAP_PKG_NAME, 'gmap_gmap_description','y'),
	array(GMAP_PKG_NAME, 'gmap_gmap_discuss','n'),
	array(GMAP_PKG_NAME, 'gmap_gmap_rankings','y'),
	array(GMAP_PKG_NAME, 'gmap_gmap_usrlock','n'),
	array(GMAP_PKG_NAME, 'gmap_keep_versions','1'),
	array(GMAP_PKG_NAME, 'gmap_maxVersions','0'),
	array(GMAP_PKG_NAME, 'gmap_w_use_db','y'),
	array(GMAP_PKG_NAME, 'gmap_w_use_dir',''),
	array(GMAP_PKG_NAME, 'gmap_warn_on_edit_time','2'),
	...
	array(GMAP_PKG_NAME, 'gmap_gmapHomePage','Welcome'),
	array(GMAP_PKG_NAME, 'gmap_gmapLicensePage',''),
) );
