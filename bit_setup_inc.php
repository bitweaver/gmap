<?php
	...
	$gBitSystem->registerPackage( 'bitmapki', dirname( __FILE__).'/' );

	/*wj: dont think I need this at this point - related to tiki_content?
...
//wj: following was commented out in wiki package		
/*
